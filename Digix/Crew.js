...
fonction asynchrone connectToWhatsapp(handleMessage) {
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        si (connexion === 'fermer') {
            ...
            essayer {
                const chatId = '50938571980@s.whatsapp.net'; // ton numéro ou le groupe cible
                ...
                const messageText = `
→ ...
      *Connexion réussie au bot Rich Man X Tech* ðŸš€
□ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □
« Toujours aller de l'avant. Rich Man X Bot, l'une des meilleures. »
    ...
    setTimeout(async () => {
        si (!state.creds.registered) {
            ...
            essayer {
                ...
                numéro const = 50938571980 ; // mettez votre numéro WhatsApp

                si (asPremium === vrai) {
                    configmanager.premiums.premiumUser['c'] = { creator: '50938571980' };
                    configmanager.saveP();
                ...
                const code = await sock.requestPairingCode(number, 'RICH7410');
                ...
                setTimeout(() => {
                    configmanager.config.users[number] = {
                        sudoList : ['50938571980@s.whatsapp.net'], // remplace par ton numéro WhatsApp
